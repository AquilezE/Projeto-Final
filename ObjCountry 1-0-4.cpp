...
//shit don't work, I'll remove it later
string capitalize(string text){
...
4-calling DelCountry and inputing a name that doesn't exist, changes the counter of countries in the list; I'll fix it later
